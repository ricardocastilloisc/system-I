...
import {
  LoadAUDGENPROCESOS,
  LoadAUDGENPROCESOError,
  LoadAUDGENPROCESOSuccess,
  UnsetAUDGENPROCESO,
} from '../actions/AUDGENPROCESO.actions';
...
export let AUDGENPROCESOReducer = (state, action) =>
  _AUDGENPROCESOReducer(state, action);
