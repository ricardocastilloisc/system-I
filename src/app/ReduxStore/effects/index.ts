...
export const EffectsArrays: any [] = [AUDGENPROCESOSEfffects,ListadoUsuariosEfffects,AUDGENESTADOPROCESOEfffects, AUDGENEJECUCIONESPROCESOEfffects, CATPROCESOSEfffects]
